...
Download BDFDB from the [official BDFDB library page](https://mwittrien.github.io/BetterDiscordAddons/Library/0BDFDB.plugin.js) and enable it before enabling Home Page.
